...
CREATE TABLE `users` (
  ...
  `cooking_time` BIGINT NOT NULL DEFAULT 0,
  `cooking_count` BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE `recipe_views` (
  ...
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_recipe_views_recipe_id_user_id` (`recipe_id`, `user_id`),
...
('肥牛饭', '#沙茶酱 #肥牛饭 #快手菜 #下饭神器', '/generated_images/course/沙茶酱-肥牛饭-快手菜-下饭神器.jpg', '/videos/沙茶酱-肥牛饭-快手菜-下饭神器.mp4'),
('酱菜', '355 #下饭菜 #酱菜 #直播中心 #在家做快手菜 注意：记得少放点盐去腌制，要不就会很咸，酱油不用跟菜持平，否则也会太咸', '/generated_images/course/下饭菜-酱菜-在家做快手菜.jpg', '/videos/下饭菜-酱菜-在家做快手菜.mp4'),
('小炒洋葱牛肉', '上班族必备快手菜~小炒洋葱牛肉，简单下饭', '/generated_images/course/上班族必备快手菜-小炒洋葱牛肉-简单下饭.jpg', '/videos/上班族必备快手菜-小炒洋葱牛肉-简单下饭.mp4'),
('家常菜', '家常菜 下饭神器 快手菜 日常美食 美食教程', '/generated_images/course/家常菜-下饭神器-快手菜-日常美食-美食教程.jpg', '/videos/家常菜-下饭神器-快手菜-日常美食-美食教程.mp4'),
('红烧茄子', '家庭版“红烧茄子”详细做法步骤告诉你     #家常菜 #红烧茄子 #下饭菜', '/generated_images/course/家庭版-红烧茄子-详细做法.jpg', '/videos/家庭版-红烧茄子-详细做法.mp4'),
('手撕包菜', '手撕包菜，简单快手菜的天花板！清脆爽口，下饭神器～#家常菜分享  #手撕包菜的做法  #美味食谱 #美食制作分享', '/generated_images/course/手撕包菜-清脆爽口.jpg', '/videos/手撕包菜-清脆爽口.mp4'),
('番茄土豆炖牛肉', '番茄土豆炖牛肉的做法教程#美食 #家常菜 #美食教程 #美食做法', '/generated_images/course/番茄土豆炖牛肉-做法教程.jpg', '/videos/番茄土豆炖牛肉-做法教程.mp4'),
('番茄炒豆腐', '番茄炒豆腐｜家常菜做法｜番茄炒雞蛋吃了幾十年，原來番茄炒豆腐更下飯【山哥山嫂】', '/generated_images/course/番茄炒豆腐-家常菜-山哥山嫂.jpg', '/videos/番茄炒豆腐-家常菜-山哥山嫂.mp4'),
('萝卜丸子', '萝卜丸子新做法教程 #家庭菜 #美味食谱 #美食制作分享 #美食#美食教程 #家常菜', '/generated_images/course/萝卜丸子-新做法教程.jpg', '/videos/萝卜丸子-新做法教程.mp4'),
('酸辣鸡丁', '酸辣开味，香嫩可口的下饭菜、快手菜《酸辣鸡丁》', '/generated_images/course/酸辣鸡丁-酸辣开味.jpg', '/videos/酸辣鸡丁-酸辣开味.mp4');
